...
# Eastmoney public web token for the search/suggest API.
# Read from env so it is never hardcoded in the repo; the default is the
# public token shipped with Eastmoney's web client (not a personal secret).
EM_SEARCH_TOKEN = os.environ.get("EM_SEARCH_TOKEN", "D43BF722C8E33BDC906FB84D85E326E8")
...
def _search(q: str) -> dict | None:
    ...
    params = {"input": q, "type": 14,
              "token": EM_SEARCH_TOKEN, "count": 10}
    try:
