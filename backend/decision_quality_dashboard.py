# -*- coding: utf-8 -*-
"""
Decision Quality Dashboard（Phase 2.0）— Checkpoint C 三指标
...
现状：真实 cio_decision_history 仅 1 条(2026-08-03)，远不足以计算。
...
def compute():
    ...
    return {
        ...
        'note': '真实 decision history 不足 30 条，三指标暂不可计算；'
