...
# Read from env so they are never hardcoded in the repo; defaults are the
# public identifiers shipped with Eastmoney's web client (not personal secrets).
EM_APP_ID = os.environ.get("EM_APP_ID", "appId01")
EM_GLOBAL_ID = os.environ.get("EM_GLOBAL_ID", "786e4c21-70dc-435a-93bb-38")
...
def hot_concepts(code: str) -> list[dict]:
    ...
    try:
        ...
        r = requests.post(
            ...
            json={"appId": EM_APP_ID, "globalId": EM_GLOBAL_ID, "srcSecurityCode": prefix + code},
